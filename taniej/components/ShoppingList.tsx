...
const COMMON_PRODUCTS: Product[] = [
  ...
  // ── Loose/weight-sold produce (commonly seen on receipts) ──
  { name: "Patyczki do szaszłyków", unit: "100 szt." },
  { name: "Filet z dorsza", unit: "1kg" },
  { name: "Filet z mintaja", unit: "1kg" },
  { name: "Pstrąg", unit: "1kg" },
  { name: "Karp", unit: "1kg" },
  { name: "Makrela", unit: "1kg" },
  { name: "Cukinia", unit: "1kg" },
  { name: "Bakłażan", unit: "1kg" },
  { name: "Cukinia żółta", unit: "1kg" },
  { name: "Dynia", unit: "1kg" },
  { name: "Por", unit: "1kg" },
  { name: "Seler", unit: "1kg" },
  { name: "Pietruszka korzeń", unit: "1kg" },
  { name: "Pietruszka natka", unit: "1 pęczek" },
  { name: "Koperek", unit: "1 pęczek" },
  { name: "Szczypior", unit: "1 pęczek" },
  { name: "Burak", unit: "1kg" },
  { name: "Rzodkiewka", unit: "1 pęczek" },
  { name: "Kapusta pekińska", unit: "1 szt." },
  { name: "Kapusta czerwona", unit: "1kg" },
  { name: "Kalafior", unit: "1 szt." },
  { name: "Brukselka", unit: "500g" },
  { name: "Kiwi", unit: "1kg" },
  { name: "Gruszki", unit: "1kg" },
  { name: "Śliwki", unit: "1kg" },
  { name: "Brzoskwinie", unit: "1kg" },
  { name: "Nektarynki", unit: "1kg" },
  { name: "Czereśnie", unit: "1kg" },
  { name: "Mandarynki", unit: "1kg" },
  { name: "Grejpfrut", unit: "1kg" },
  { name: "Ananas", unit: "1 szt." },
  { name: "Granat", unit: "1 szt." },
  { name: "Imbir", unit: "1kg" },
  { name: "Limonka", unit: "1 szt." },
  { name: "Karkówka", unit: "1kg" },
  { name: "Żeberka", unit: "1kg" },
  { name: "Schab bez kości", unit: "1kg" },
  { name: "Łopatka", unit: "1kg" },
  { name: "Mielone wieprzowe", unit: "500g" },
  { name: "Filet z kurczaka", unit: "1kg" },
  { name: "Wątróbka drobiowa", unit: "400g" },
  { name: "Krewetki mrożone", unit: "200g" },
  { name: "Tofu", unit: "200g" },
  { name: "Kasza pęczak", unit: "500g" },
  { name: "Kasza manna", unit: "400g" },
  { name: "Komosa ryżowa", unit: "500g" },
  { name: "Bułki kajzerki", unit: "6 szt." },
  { name: "Chleb żytni", unit: "500g" },
  { name: "Chleb pełnoziarnisty", unit: "500g" },
];
